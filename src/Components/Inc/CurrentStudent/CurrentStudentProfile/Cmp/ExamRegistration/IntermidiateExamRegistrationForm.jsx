...
const IntermidiateExamRegistrationForm = ({formik}) => {
    ...
    <table style={{ border: '1px  #333', borderCollapse: 'collapse' }}>
                        ...
                        {/* preliminary checkbox 3 */}
                                      ...
                                      <tr>
                                        ...
                                        <td style={{ textAlign: "left", fontSize:'15px' }}>
                                        Environmental Law  (for students those who have not passed this
subject as an optional subject at the
...
export default IntermidiateExamRegistrationForm
