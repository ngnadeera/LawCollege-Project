...
const FinalExamComponent = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async() => {
            ...
            const response = await axios.get('http://localhost:3001/Final_exam_results',  {
                headers: {
 ...
 <Container fluid>
          ...
          {loading ? (
            ...
            <>
              <p className='d-flex align-items-center' style={{marginTop:'30px'}}>You have't completed any exam in Final year</p>
            </>
          ) : resultList.length > 0 ? (
            <>
              <div>
                    ...
                    <Container fluid>
                      <Row>
                        <Col className="d-flex justify-content-center align-items-center">
                          ...
                          >
                            <b>Final Exam Results - 20{resultList[index].IndexNo.substring(0, 2)}</b>
                          </Typography>
                        </Col>
                      </Row>
