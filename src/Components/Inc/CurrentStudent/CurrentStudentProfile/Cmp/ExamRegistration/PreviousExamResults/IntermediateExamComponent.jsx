...
const IntermediateExamComponent = () => {
...
const[noData,setNodata] = useState(false);
    ...
    useEffect(() => {
        ...
        const fetchData = async() => {
            ...
            const response = await axios.get('http://localhost:3001/Intermidiate_exam_results',  {
                headers: {
 ...
 <Container fluid>
          ...
          {loading ? (
            ...
            <>
              <p className='d-flex align-items-center' style={{marginTop:'30px'}}>You have't completed any exam in Intermidiate year</p>
            </>
          ) : resultList.length > 0 ? (
            <>
              <div>
                    ...
                    <Container fluid>
                      <Row>
                        <Col className="d-flex justify-content-center align-items-center">
                          ...
                          >
                            <b>Intermidiate Exam Results - 20{resultList[index].IndexNo.substring(0, 2)}</b>
                          </Typography>
                        </Col>
                      </Row>
...
export default IntermediateExamComponent
